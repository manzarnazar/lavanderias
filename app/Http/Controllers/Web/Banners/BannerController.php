...
class BannerController extends Controller
{
    ...
    public function store(BannerRequest $request)
    {
        ...
        return to_route('banner.promotional')->with('success', 'A new banner added successfully');
    }
    ...
    public function update(BannerRequest $request, Banner $banner)
    {
        ...
        return to_route('banner.promotional')->with('success', 'Banner updated successfully');
    }

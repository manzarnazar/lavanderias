                            ...
                            <form action="{{ route('register-user') }}" method="post" class="content">
                                ...
                                <div class="input-items mb-4 flex flex-wrap md:flex-nowrap gap-[0] md:gap-3">
                                    ...
                                    <div class="w-full md:w-[50%]">
                                        <label
                                            ...
                                            Name</label>
                                        <div class="relative">
                                            <input class="w-full !pl-4" name="last_name" type="text"
                                ...
                                <div class="input-items mb-4">
                                    <label
                                        ...
                                        Name<span style="color:red">*</span></label>
                                    <div class="relative">
                                        <input class="w-full !pl-4" type="text" name="business_name"
                                            placeholder="Your laundry business" value="{{ old('business_name') }}">
                                        @error('business_name')
                                            <span class="text-danger" style="color:red">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="input-items mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input class="w-full" type="email" name="email"
                                            placeholder="Enter your email address" value="{{ old('address') }}">
                                ...
                                <div class="input-items mb-4">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input class="w-full" name="mobile" type="number"
                                ...
                                <div class="input-items mb-6">
                                    <label
                                        class="block text-base md:text-lg font-medium leading-[120%] text-neutral-700 mb-[10px]">Password<span
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const isCustomer = @json($user?->hasRole('store') ?? false);

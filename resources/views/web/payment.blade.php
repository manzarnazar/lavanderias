...
<body>
    <div class="container my-3">
        <div class="content-page">
            <div class="web-logo">
                <a href="http://laundry.razinsoft.com/"><img src="{{ asset('web/logos/logo.png') }}" alt="" width="100%"></a>
            </div>
                ...
                <div class="col-lg-6 m-auto">
                    ...
                    <div class="card text-white bg-success mb-3">
                        <div class="card-body">
                            ...
                            <p class="card-text text-lite">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 order">
                                        Picked At : <span>{{ Carbon\Carbon::parse($order->pick_date)->format('d M, Y') }} - {{ substr($order->pick_hour, 0, 5) }}</span>
                                    </p>

                                    <p class="mb-0 order">
                                        Delivery At : <span>{{ Carbon\Carbon::parse($order->delivery_date)->format('d M, Y') }} - {{ substr($order->delivery_hour, 0, 5) }}</span>
                                    </p>
                                    ...
                                    <p class="mb-0 order">
                                        Delivery Cost : <span>{{ currencyPosition($order->amount <= $freeDelivery ? $deliveryCharge : '00')  }}</span>
                                    </p>

                                    <p class="mb-0 order">
                                        Discount : <span class="text-danger"> -{{  currencyPosition($order->discount) }}</span>
                                    </p>
                                    ...
                                    <div class="col-md-12 pr-0 mt-2 text-right">
                                        <button class="btn btn-primary btn-lg px-5 paynow" id="pay-now" >Pay Now
                                            ...
                                            <img width="20" id="load" class="ml-2 position-absolute" style="display: none" src="{{ asset('images/loader/loader.gif') }}" alt="">
                                        </button>
                                        <p class="m-0 pr-1 text-right">
                                            <span id="success" style="display: none" class="text-success">Payment is received successfully.</span>
                                            <span id="error" style="display: none" class="text-danger">Somthing was wrong.</span>
                                        </p>
                                    </div>
                                </div>
                            </div>

                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col mt-3 text-right">
                                        <h4 class="card-title text-uppercase text-muted mb-0">{{ __('Earnings') }}</h4>
                                        <span class="display-3 text-dark font-weight-bold mb-0">
                                            @can('dashboard.calculation')
                                                {{ $services->count() }}
                                            @else
                                    ...
                                    <div class="card-icon">
                                        <div class="icon icon-shape text-white shadow">
                                            <img width="80" src="{{ asset('images/icons/earning.svg') }}"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            @can('revenue.index')
                                <div>
                                    <div class="dropdown">
                                        <button class="btn btn-secondary py-1 dropdown-toggle" type="button"
                                            id="filter-revunue" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="filter-revunue">
                                            ...
                                            <a class="dropdown-item"
                                                href="{{ route('root', ['type' => 'week']) }}">{{ __('Week') }}</a>
                                            <a class="dropdown-item"
                                                href="{{ route('root', ['type' => 'month']) }}">{{ __('This_Month') }}</a>
                                            <a class="dropdown-item"
                                                href="{{ route('root', ['type' => 'year']) }}">{{ __('This_Year') }}</a>
                                        </div>
                                    </div>
                                    @php
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                @else
                                    <tr class="text-center">
                                        <td colspan="5">
                                            {{ __('Sorry') . ', ' . ucfirst(\request()->type) ? __(ucfirst(\request()->type)) : __('Today') }}
                                            {{ __('revenue_not_found') }}</td>
                                    </tr>
                                @endcan
                                <tr>
